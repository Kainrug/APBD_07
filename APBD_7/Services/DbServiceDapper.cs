...
public class DbService(IConfiguration configuration) : IDbService
{
    ...
    public async Task<Product_Warehouse?> GetProductWarehouseByOrderId(int orderId)
    {
        await using var connection = await GetConnection();
        var command = new SqlCommand(
    ...
    public async Task<Product_Warehouse?> InsertToProductWarehouse(int warehouseId, int productId, int orderId, int amount, DateTime createdAt)
    {
        await using var connection = await GetConnection();
    ...
    public async Task<Product_Warehouse?> GetLastCreatedProductWarehouse()
    {
        await using var connection = await GetConnection();
        var command =
            new SqlCommand(
